...
%	\tikzifexternalizing{Work-around to make animate happy	}{}%https://tex.stackexchange.com/a/39026/828
		\begin{tikzpicture}
			...
			\fill[gray] (-0.5,-1.25) rectangle node (detector) [black] {Detector} +(1,0.25);
...
% 					}
% 					% Rotation arc
% 					\draw[->, line cap=rect] (0.618,0) arc [start angle=0, end angle=180, radius=0.618];
% 					\draw[->, line cap=rect] (-0.618,0) arc [start angle=-180, end angle=0, radius=0.618];
% 					% Sample
% 					\node[ubRedComplementary] at (0,0) (sample) {\rotatebox{\n}{\normalsize\faFish}};
% 				\mode<beamer>{%
% 					\end{scope}
