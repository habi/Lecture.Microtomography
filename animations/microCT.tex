...
%	\tikzifexternalizing{Work-around to make animate happy	}{}%https://tex.stackexchange.com/a/39026/828
		\begin{tikzpicture}[scale=2]
			...
			\fill[ubRedComplementary2,fill] (-0.5,-1.25) rectangle node (detector) [black,fill=white,semitransparent,text opacity=1] {Detector} +(1,0.25);
			...
			\begin{scope}[rotate around={\n:(0,0)}]
				...
				% Sample
				\node[ubRedComplementary1] at (0,0) (sample) {\huge\faFish};
			\end{scope}
		\end{tikzpicture}
	}
\end{animateinline}
