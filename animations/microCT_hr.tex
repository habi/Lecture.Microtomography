	...
	\multiframe{90}{n=1+4}{%
		\begin{tikzpicture}[scale=1.5]
			...
			% Stuff that moves
				...
				% Rotation arc
				\draw[->, thick,line cap=rect] (0.5,0.5) arc [start angle=0, end angle=180, radius=0.5];
				\draw[->, thick,line cap=rect] (-0.5,0.5) arc [start angle=-180, end angle=0, radius=0.5];
				% Sample
