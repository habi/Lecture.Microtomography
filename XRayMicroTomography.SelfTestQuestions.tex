...
\begin{questions}
    ...
    \question Describe what happens with the X-rays once they are emitted from the X-ray source until they are converted to an image in the detector of a desktop \mct or large human CT\@.
    ...
    \question A researcher wants to image a sample with approximately \qty{30}{\centi\meter} with a very small voxel size (let's say below \qty{1}{\micro\meter}).
