...
\title{Self-test questions for the lecture on \href{https://ilias.unibe.ch/go/sess/3400779}{X-ray microtomography}}
...
\begin{questions}
  ...
  \question{}
  How to the physical properties of the sample influence the gray values in the projection image recorded by the camera?
  ...
  \question{}
  Can the researcher scan a sample approximately \qty{3}{\milli\meter} width with a voxel size of \qty{50}{\micro\meter}?
  Does that make sense?

  \question{}
  How are voxel size in the image and feature of interest related?
  No only in \uct, but also in other imaging methods\ldots

  \question{}
  Why can you not visualize any blood vessels in \autoref{fig:1265}\footnote{Different visualizations of \emph{Mouse 1265} in \autoref{fig:1265} have been shown throughout the lecture.}, while they are nicely visualized  in \autoref{fig:5158} (in the brain towards the top right and in the tongue at the bottom)?
  ...
  \begin{figure}
    ...
    \begin{subfigure}[t]{0.5\linewidth}%
      ...
      \caption{\emph{Mouse 5158}.
        ...
        The blood vessels are nicely visible in both the brain and the tongue.
