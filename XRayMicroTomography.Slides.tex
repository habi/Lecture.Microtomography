...
||||||| Stash base
\subtitle{\href{https://ilias.unibe.ch/goto_ilias3_unibe_sess_3022947.html}{9256-HS2024-0: Advanced Microscopy}}
=======
\subtitle{\href{https://ilias.unibe.ch/go/sess/3400779}{9256-HS2025-0: Advanced Microscopy }}
>>>>>>> Stashed changes
...
\begin{frame}
  ...
  \only<1|handout:0>{%
    \citeslide{./images/Fundamentals_image_processing_2024-021}{https://ilias.unibe.ch/goto_ilias3_unibe_sess_3022928.html}{Fundamentals of Digital Image Processing}{Guillaume Witz}{21}%
  }%
  \only<2|handout:1>{%
    \citeslide{./images/Fundamentals_image_processing_2024-023}{https://ilias.unibe.ch/goto_ilias3_unibe_sess_3022928.html}{Fundamentals of Digital Image Processing}{Guillaume Witz}{23}%
  }%
\end{frame}
...
\begin{frame}
  ...
  \centering
  % Download Michaels slides from https://ilias.unibe.ch/goto_ilias3_unibe_sess_3022922.html
  % pdfseparate MiC\ physical\ basics.pdf MiC\ physical\ basics-%03d.pdf
  \citeslide{./images/MiC physical basics-004}{https://ilias.unibe.ch/goto_ilias3_unibe_sess_3022922.html}{Contrast, Magnification and Resolution}{Michael Jaeger}{4}%
\end{frame}
