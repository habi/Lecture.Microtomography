...
<<<<<<< HEAD
	\xspace Generated on \DTMnow, from \href{https://github.com/habi/Lecture.Microtomography/commit/\gitHash}{\gitAbbrevHash}\xspace|%
=======
	\xspace\gitAbbrevHash\xspace\DTMnow\xspace|%
>>>>>>> 54f367080474b12f6386b0c9c83fab63482805f0
	...
	\begin{columns}%
		...
		\begin{column}{0.62\textwidth}%
			\begin{itemize}%
				...
				\item<1-|handout:1> Non-destructive imaging\only<2>{, thus compatible with routine sample preparation}
				\item<1-|handout:1> Results in three-dimensional images \only<2>{with \unit{\micro\meter} resolution}
