...
% Progress bar marker
% After fiddling with ChatGPT and Claude.ai for making a nice progress marker in the top red bar of the template, I asked Google Gemini.
% It delivered...
...
% Initialize the end slide variable
% This *needs* to be written to the .aux file after calling \appendix, see the three lines there
...
\newcommand{\myprogressbar}{%
  \ifnum\insertframenumber>2
    \begin{tikzpicture}[remember picture, overlay]
      ...
      \edef\ratio{\fpeval{min(max((\insertframenumber - 3) / max(\appendixframeno - 3, 1), 0), 1)}}
      % Draw a circle as marker in the red top bar
      \fill[white] (\barstart + \ratio\barmaxwidth, -0.68mm) circle (0.68mm); % 0.68 is 1.36/2
    \end{tikzpicture}
  \fi
}
% Set the progress bar as header in presentation mode
\mode<beamer>{%
  \setbeamertemplate{headline}{\myprogressbar}
}
