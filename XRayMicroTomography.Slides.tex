...
\begin{frame}
  \frametitle{Imaging}
  \centering
  % Download Nadias presentation from https://ilias.unibe.ch/ilias.php?baseClass=ilrepositorygui&cmd=infoScreen&ref_id=3022933
  % Then `https://ilias.unibe.ch/ilias.php?baseClass=ilrepositorygui&cmd=infoScreen&ref_id=3022933` and copy relevant slide images to here
  \only<1|handout:0>{\citeslide{./images/SPIM 2024-033}{https://ilias.unibe.ch/goto_ilias3_unibe_sess_3022933.html}{Light Sheet Microscopy}{Nadia Mercader}{33}}%
  \only<2|handout:1>{\citeslide{./images/SPIM 2024-043}{https://ilias.unibe.ch/goto_ilias3_unibe_sess_3022933.html}{Light Sheet Microscopy}{Nadia Mercader}{43}}%
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Reproducible research, \ie{} pretty images are nice, but we want quantitative numbers
      ...
      \end{itemize}
    \item Also see \href{https://ilias.unibe.ch/go/sess/3400760}{\emph{Fundamentals of Digital Image Processing} by Guillaume Witz}(, especially the part after \emph{MATERIAL FOR EXAM STOPS HERE}.)
  \end{itemize}
\end{frame}
