...
\begin{frame}
    ...
    \only<3|handout:0>{%
        % Since the animation is too slow, we specifically set it double speed here
        \animategraphics[autoplay,width=\imagewidth,every=\numexpr2*\everyframe\relax]{24}{./movies/EAWAG/animation.pj/104016.pj.animation.0}{000}{700}%
    }%
    \only<4|handout:0>{%
        % Since the animation is too slow, we specifically set it double speed here
        \animategraphics[autoplay,width=\imagewidth,every=\numexpr2*\everyframe\relax]{24}{./movies/EAWAG/animation.pj/104016.pj.animation.}{0701}{1440}%
    }%
