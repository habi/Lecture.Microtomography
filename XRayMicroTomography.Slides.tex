...
\begin{frame}
    ...
    \begin{tikzpicture}[remember picture,overlay]
        \node at (current page.center) {%
            \mode<beamer>{\animategraphics[autoplay,loop,height=0.98\paperheight,every=\everyframe]{24}{./movies/scan/visualization/lung}{000}{240}}%
            \mode<handout>{\includegraphics[height=0.98\paperheight]{./movies/scan/visualization/lung000}}%
        };
    \end{tikzpicture}%
\end{frame}
