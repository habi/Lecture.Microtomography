...
\addtobeamertemplate{footline}{}{%
  \mode<beamer>{%
    \begin{tikzpicture}%
      \useasboundingbox (0, \progressbarheight) rectangle (\paperwidth, \progressbarheight);%
      \draw[draw=ubRed, fill=white] (\insertframenumber/\inserttotalframenumber*\paperwidth, \progressbarheight) circle (\progressbarheight/2);%
    \end{tikzpicture}%
  }%
