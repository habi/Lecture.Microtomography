...
\begin{frame}
  ...
  \begin{itemize}%
    \item<1-2> Pretty images are nice to have, but science is built on quantitative data% force to show this on frame 1 AND 2, so that we can first show the hovering tooth
