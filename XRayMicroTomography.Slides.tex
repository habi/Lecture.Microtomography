...
\begin{frame}{Hello!}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Cancer research: Melanomam			
	...
	\begin{columns}
		\begin{column}{0.49\linewidth}
			\begin{itemize}
				...
				\begin{itemize}
					\item<1-|handout:1-> \citeyear{Cormack1963}: \citeauthor{Cormack1963} used a collimated \isotope[60]{Co} source and a Geiger counter as a detector~\cite{Cormack1963}
...
\begin{frame}[label=current]{References}
