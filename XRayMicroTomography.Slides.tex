...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item X-ray penetration decreases exponentially with sample thickness~\cite[\ie Beer-Lambert law]{wiki:beer-lambert}: \(I(t) = I_0 \, e^{-\alpha z}\)
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        \item High efficiency: scaling the number of samples demands no extra manual work
