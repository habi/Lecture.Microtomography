...
\begin{frame}
	...
	\begin{itemize}
		\item Pretty images are nice to have, but science is quantitative data
		\item Segmentation
...
\renewcommand{\everyframe}{1}% use only every nth frame for the animations
...
\begin{frame}
	...
	\end{columns}
\end{frame}
\renewcommand{\everyframe}{2}% use only every nth frame for the animations
