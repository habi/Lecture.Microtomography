...
<<<<<<< Updated upstream
				...
				\item Automate \emph{all} the things!~\cite{Haberthuer2021}
=======
...
>>>>>>> Stashed changes
		...
		\begin{column}{0.382\linewidth}
			\centering
			\includegraphics<1|handout:0>[height=\imageheight]{./images/1172}%
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Electron microscopy: see lectures
			\href{https://ilias.unibe.ch/goto_ilias3_unibe_sess_2788105.html}{\emph{Analytical electron microscopy} by Dimitri},
			\href{https://ilias.unibe.ch/goto_ilias3_unibe_sess_2177954.html}{\emph{SEM Grundlagen} by Sabine Kässmeyer and Ivana Jaric} and
			\href{https://ilias.unibe.ch/goto_ilias3_unibe_sess_2177956.html}{\emph{Cryoelectron Microscopy \& Serial Block Face SEM} by Ioan}.
	\end{itemize}
\end{frame}
...
\begin{frame}[label=current]
	...
	\mode<handout>{\includegraphics[height=\imageheight]{./movies/scan/projections/KP-TNIKWT02_360_projections_of_940_800_px_}}
\end{frame}
...
\begin{frame}
	...
	\centering
	\includegraphics[height=\imheight]{{{./images/zmk/ScanOverviews.24}}}%
=======
\subsection{Results}
...
\begin{frame}
	\frametitle{\uct imaging}
	\centering
	\includegraphics<1|handout:0>[height=\imageheight]{{{./images/ScanOverviews.104}}}%
	\includegraphics<2>[height=\imageheight]{{{./images/ScanOverviews.24}}}%
>>>>>>> Stashed changes
\end{frame}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.618\linewidth}
			\centering%
<<<<<<< Updated upstream
			\includegraphics<1|handout:1>[width=\imwidth]{{./images/zmk/tooth045/Tooth045.Cropper.Original}}%
			\includegraphics<2|handout:2>[width=\imwidth]{{./images/zmk/tooth045/Tooth045.Cropper.Cropped}}%
=======
			\includegraphics<1|handout:1>[width=\imagewidth]{{./images/tooth045/Tooth045.Cropper.Original}}%
			\includegraphics<2|handout:2>[width=\imagewidth]{{./images/tooth045/Tooth045.Cropper.Cropped}}%
>>>>>>> Stashed changes
		\end{column}
	\end{columns}
\end{frame}
...
<<<<<<< Updated upstream
			\only<2|handout:2>{\includegraphics[height=\imheight]{./images/zmk/briseno}\sourcecite{Briseno-Marroquin2015}{Fig.~2}}%
=======
...
\begin{frame}
	...
	\only<1|handout:1>{%
<<<<<<< Updated upstream
		\includegraphics[height=\imheight]{{./images/zmk/tooth045/Tooth045.ExtractedSlices}}%
=======
		\includegraphics[height=\imageheight]{{./images/tooth045/Tooth045.ExtractedSlices}}%
>>>>>>> Stashed changes
		}%
	\only<2|handout:2>{%
		\includegraphics[width=\linewidth]{{./images/zmk/tooth045/Tooth045.Briseno}}%
		}%
\end{frame}
...
\begin{frame}
	...
	\centering
	\includegraphics[width=\imagewidth]{./images/can_eb03_hart_0_4um_al0_25_80kv_rec0000}%
\end{frame}
