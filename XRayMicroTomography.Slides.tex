...
\usepackage{lstlinebgrd}%https://tex.stackexchange.com/a/58543/828
...
\newcommand{\citeslide}[5]{% slideimage,lecturelink,lecturetitle,author,page
  ...
  \begin{tcolorbox}[enhanced,colframe=ubRed,drop shadow,hbox,size=tight]{%
      \includegraphics[height=\imageheight]{#1}%
      \sourcelink{#2}{\emph{#3} by #4}{Slide #5}%
    }%
  \end{tcolorbox}%
}%
...
\addtobeamertemplate{footline}{}{%
  \mode<beamer>{%
    \begin{tikzpicture}%
      ...
      \draw[draw=ubRed,fill=white] (\insertframenumber/\inserttotalframenumber*\paperwidth, \progressbar@height) circle (\progressbar@height*0.5);%
    \end{tikzpicture}%
  }%
...
\begin{frame}
  ...
  \begin{columns}[onlytextwidth]
    ...
    \begin{column}{0.4\linewidth}
      ...
      \includegraphics<3|handout:3>[width=\imagewidth]{./images/History_Generation1}%
      \only<3|handout:3>{\sourcecite{Hsieh2003}{Figure 1.12}}%
      \includegraphics<4|handout:4>[width=\imagewidth]{./images/History_Generation2}%
      \only<4|handout:4>{\sourcecite{Hsieh2003}{Figure 1.13}}%
...
\begin{frame}
  ...
  \citeslide{./images/MiC physical basics-004}{https://ilias.unibe.ch/goto_ilias3_unibe_sess_3022922.html}{Contrast, Magnification and Resolution - Laws of Physics for Microscopists (1)}{Michael Jaeger}{4}%
\end{frame}
...
\begin{frame}
  ...
  \citeslide{./images/physical_basics_2023_folien-21.pdf}{https://ilias.unibe.ch/goto_ilias3_unibe_sess_2774486.html}{Contrast, Magnification and Resolution---Laws of Physics for Microscopists (1), 2023}{Martin Frenz}{21}%
\end{frame}

%\renewcommand{\imageheight}{0.75\paperheight}
\begin{frame}
...
% \begin{frame}
%   \renewcommand{\imageheight}{0.4\paperheight}%
%   \frametitle{Results of root canal space extraction}%
%   \centering%
%   \includegraphics[height=\imageheight]{./images/zmk/rcs/Tooth0452}\hfill%
%   \includegraphics[height=\imageheight]{./images/zmk/rcs/Tooth0278}\hfill%
%   \includegraphics[height=\imageheight]{./images/zmk/rcs/Tooth0353}\hfill%
%   \includegraphics[height=\imageheight]{./images/zmk/rcs/Tooth0419}\hfill%
%   \includegraphics[height=\imageheight]{./images/zmk/rcs/Tooth0642}\hfill%
%   \includegraphics[height=\imageheight]{./images/zmk/rcs/Tooth0752}\hfill%
