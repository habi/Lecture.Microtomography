...
\date{December 23, 2021 | \href{https://ilias.unibe.ch/goto_ilias3_unibe_sess_2466944.html}{9256-HS2022-0: Advanced Microscopy}}
...
\newcommand{\imheight}{0.9\paperheight}% set global image height
...
\renewcommand{\imheight}{0.6\paperheight}
\section{Overview}
\begin{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Light (sheet) microscopy: see \href{https://ilias.unibe.ch/goto_ilias3_unibe_sess_2466931.html}{lecture of Nadia Mercader Huber}
		\item X-ray imaging
		\item Electron microscopy: see lectures
			\href{https://ilias.unibe.ch/goto_ilias3_unibe_sess_2466936.html}{\emph{Transmission Electron Microscopy} by Dimitri Vanhecke},
			\href{https://ilias.unibe.ch/goto_ilias3_unibe_sess_2466940.html}{\emph{Scanning Electron Microscopy} by Sabine Kässmeyer \& Ivana Jaric} and
			\href{https://ilias.unibe.ch/goto_ilias3_unibe_sess_2466942.html}{\emph{Cryoelectron Microscopy \& Serial Block Face SEM} by Ioan Iacovache}.
	\end{itemize}
\end{frame}
...
\note{The human head scan was downloaded from the \href{https://www.cancerimagingarchive.net}{Cancer Imaging Archive}.
	...
	According to the DICOM tags, the voxel size is \qtyproduct{0.4883 x 0.4883 x 0.625}{\milli\meter\cubed}, the image size is 512\(\times\)512 pixels.
...
\begin{frame}
	...
	\sourcelink{ilias.unibe.ch/goto_ilias3_unibe_sess_2466919.html}{\emph{Fundamentals of Digital Image Processing} by Guillaume Witz}{Slide 23}%
\end{frame}
...
\begin{frame}
	...
	\sourcelink{ilias.unibe.ch/goto_ilias3_unibe_sess_2466922.html}{\emph{Contrast, Magnification and Resolution---Laws of Physics for Microscopists (1)} by Martin Frenz}{Slide 21}%
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Also see \href{https://ilias.unibe.ch/goto_ilias3_unibe_sess_2466919.html}{\emph{Fundamentals of Digital Image Processing} by Guillaume Witz}
	...
	\begin{columns}
		...
		\begin{column}{0.49\linewidth}
			...
			\only<6|handout:6>{%
				...
				\mode<handout>{%
					\includegraphics[width=\linewidth]{./movies/coder/coder-118}%
					\source{gph.is/2nqkple}{}%
					}%
				}%
			\only<8|handout:8>{%
