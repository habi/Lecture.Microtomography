...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.49\linewidth}
			\centering%
			\includegraphics<1>[height=\imageheight]{./images/cichlids/104016}%
			\only<2>{%
...
\begin{frame}
	...
	\includegraphics<9|handout:0>[height=\imageheight]{./images/cichlids/Otolither_104016_head_09_ExtractedOtolithMasked}%
