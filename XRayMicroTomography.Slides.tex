...
\newcommand{\imageheight}{0.8\paperheight}% set global image height
...
\def\progressbar@progressbar{%
	...
	\end{tikzpicture}%
	\hfill git.io/JqIBH\hfill|\hfill%
	v. \href{https://github.com/habi/Lecture.Microtomography/commit/\gitHash}{\gitAbbrevHash}\hfill|\hfill%
	p.\xspace\insertframenumber/\inserttotalframenumber\hfill%
	%\hspace*{4ex}%
	\vspace{0.5ex}%
	%\par%
}
...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{column}{0.49\linewidth}
			\centering
			\only<1|handout:1>{%
				\renewcommand{\imagewidth}{0.55\linewidth}% 1055/1476
	...
	\note{I was unable to find conclusive information on the voxel size of the first CT image.
		My head is approximately \SI{16}{\centi\meter} wide.
		I counted 47 voxels across the head in the image.
		This gives a voxel size of \SI{3.4}{\milli\meter} per voxel.}
\end{frame}
...
\begin{frame}
	...
	\frametitle{Results of root canal space extraction}%
		...
		\renewcommand{\imagewidth}{0.13\linewidth}% 720/2008
