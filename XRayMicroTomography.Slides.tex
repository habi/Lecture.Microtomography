...
\end{frame}
 ...
 \begin{frame}
 	...
 	\begin{tikzpicture}[remember picture,overlay]%
		\node at (current page.center){%
				\mode<beamer>{\animategraphics[autoplay,loop,width=\paperwidth,height=\paperheight,keepaspectratio,every=\everyframe]{24}{./movies/scan/visualization/lung}{000}{240}}%
		\mode<handout>{\includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{./movies/scan/visualization/lung000}}%
 		};%
 	\end{tikzpicture}%
\end{frame}
	...
	\only<1|handout:1>{%
		\begin{tikzpicture}[remember picture,overlay]%
			\node at (current page.center) [shift={(0,-2.9mm)}]{%
				\mode<beamer>{\animategraphics[autoplay,loop,width=\paperwidth,height=\paperheight,keepaspectratio,every=\everyframe]{24}{./movies/tooth045/full/image0}{000}{474}}%
				\mode<handout>{\includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{./movies/tooth045/full/image0237}}%
				};%
		\end{tikzpicture}%
	}%	
\end{frame}
