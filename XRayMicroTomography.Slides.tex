...
\begin{frame}{Contrast vs.\ Staining}
  \centering
  From \cite{Aaldijk2025}
  \includegraphics<1>[width=0.9\imagewidth]{./images/contrast/Mouse01.000.MiddleSlices}
  %\includegraphics<1>[width=0.9\imagewidth]{./images/contrast/Mouse01.121.MiddleSlices}\newline%
  \includegraphics<1>[width=0.9\imagewidth]{./images/contrast/Mouse01.238.MiddleSlices}%
  \includegraphics<2>[width=0.9\imagewidth]{./images/contrast/Mouse01.000.MiddleSlices.Lineprofile}
  %\includegraphics<2>[width=0.9\imagewidth]{./images/contrast/Mouse01.121.MiddleSlices.Lineprofile}\newline%
  \includegraphics<2>[width=0.9\imagewidth]{./images/contrast/Mouse01.238.MiddleSlices.Lineprofile}%
  \includegraphics<3>[width=0.9\imagewidth]{./images/contrast/Mouse01.000.MIPs}
  %\includegraphics<3>[width=0.9\imagewidth]{./images/contrast/Mouse01.121.MIPs}\newline%
  \includegraphics<3>[width=0.9\imagewidth]{./images/contrast/Mouse01.238.MIPs}%
\end{frame}
