...
\date{December 18, 2020 | \href{https://ilias.unibe.ch/goto_ilias3_unibe_crs_1815141.html}{9256-HS2020-0: Advanced Microscopy}}
...
\begin{frame}{Hello!}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item \uct-group, \href{https://ana.unibe.ch}{Institute of Anatomy} (Ruslan Hlushchuk, David Haberthür, Oleksiy-Zakhar Khoma)
		\end{itemize}
...
\begin{frame}{Imaging methods}
	\begin{itemize}
		\item Light (sheet) microscopy: see \href{https://ilias.unibe.ch/goto_ilias3_unibe_sess_1815157.html}{lecture of Nadia Mercader Huber}
		\item X-ray imaging
		\item Electron microscopy: see lectures
			\href{https://ilias.unibe.ch/goto_ilias3_unibe_sess_1815162.html}{\emph{Transmission Electron Microscopy} by Dimitri Vanhecke},
			\href{https://ilias.unibe.ch/goto_ilias3_unibe_sess_1815166.html}{\emph{Scanning Electron Microscopy} by Michael Stoffel} and
			\href{https://ilias.unibe.ch/goto_ilias3_unibe_sess_1815168.html}{\emph{Cryoelectron Microscopy \& Serial Block Face SEM} by Ioan Iacovache}.
	\end{itemize}
\end{frame}
...
\begin{frame}[label=current]{X-ray interaction}
	\begin{itemize}
...
\begin{frame}{MIP}
	...
	\includegraphics[height=\imheight]{./images/Fundamentals_image_processing_2020-21}%
	\sourcelink{ilias.unibe.ch/goto\_ilias3\_unibe\_sess\_1815145.html}{\emph{Fundamentals of Digital Image Processing} by Guillaume Witz}{Slide 21}%
\end{frame}
...
\begin{frame}{Projections}
	\centering
	% pdftoppm physical\ basics_2020.pdf -png physical_basics_2020
	\includegraphics[height=\imheight]{./images/physical_basics_2020-15}%
	\sourcelink{ilias.unibe.ch/goto\_ilias3\_unibe\_sess\_1815148.html}{\emph{Laws of Physics for Microscopists} by Martin Frenz}{Slide 15}%
\end{frame}
...
\begin{frame}{What to use?}
	\begin{itemize}
		...
		\item Also see \href{https://ilias.unibe.ch/goto_ilias3_unibe_sess_1815145.html}{\emph{Fundamentals of Digital Image Processing} by Guillaume Witz}
