...
\begin{frame}{Contrast vs.\ Staining}
  \centering
  \includegraphics<1|handout:1>[width=0.9\imagewidth]{./images/contrast/Mouse01.000.MiddleSlices}
  %\includegraphics<1>[width=0.9\imagewidth]{./images/contrast/Mouse01.121.MiddleSlices}\newline%
  \includegraphics<1|handout:1>[width=0.9\imagewidth]{./images/contrast/Mouse01.238.MiddleSlices}%
  \includegraphics<2|handout:2>[width=0.9\imagewidth]{./images/contrast/Mouse01.000.MiddleSlices.Lineprofile}
  %\includegraphics<2>[width=0.9\imagewidth]{./images/contrast/Mouse01.121.MiddleSlices.Lineprofile}\newline%
  \includegraphics<2|handout:2>[width=0.9\imagewidth]{./images/contrast/Mouse01.238.MiddleSlices.Lineprofile}%
  \includegraphics<3|handout:0>[width=0.9\imagewidth]{./images/contrast/Mouse01.000.MIPs}
  %\includegraphics<3>[width=0.9\imagewidth]{./images/contrast/Mouse01.121.MIPs}\newline%
  \includegraphics<3|handout:0>[width=0.9\imagewidth]{./images/contrast/Mouse01.238.MIPs}%
\end{frame}
...
\begin{frame}
  ...
  \note[item]<6|handout:6>{Fish 104016, Scan pharynx\_rec; scanned on 2021-02-04T13:30:11 on the SkyScan1272, with a voxel size of \qty{5.0}{\micro\meter}.}%
	\note[item]<6|handout:6>{The distance between the two ends at the top is approximately \qty{5}{\milli\meter}.}%
		\only<8|handout:0>{%
  ...
  \note[item]<9|handout:9>{A human hair typically has a thickness ranging from \qtyrange{17}{181}{\micro\meter}, depending on various factors like the individual's hair type, age, and ethnicity. On average, most human hair strands fall between \qtyrange{50}{100}{\micro\meter} in diameter.}%
\end{frame}
