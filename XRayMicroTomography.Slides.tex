...
\usepackage{listings}
	\lstset{frame=single,
		backgroundcolor = \color{ubRed!10},
...
\renewcommand{\imageheight}{0.618\textheight}
\section{Overview}
\begin{frame}
...
% 			\centering
% 			\only<1|handout:1>{%
% 				\renewcommand{\imagewidth}{0.715\imageheight}% 1055/1476
...
\begin{frame}
	...
	\note{The human head scan was downloaded from the \href{https://www.cancerimagingarchive.net}{Cancer Imaging Archive}.
		...
		According to the DICOM tags, the voxel size is \SI{0.4883 x 0.4883 x 0.625}{\milli\meter\cubed}, the image size is 512\(\times\)512 pixels.
...
\begin{frame}
	...
	\centering
	\includegraphics[height=\imageheight]{./images/zmk/ScanOverviews.24.png}%
\renewcommand{\imageheight}{0.618\paperheight}
\begin{frame}
	\frametitle{\uct imaging}
	\centering
	\includegraphics<1|handout:0>[height=\imageheight]{./images/ScanOverviews.104.png}%
	\includegraphics<2>[height=\imageheight]{./images/ScanOverviews.24.png}%
\end{frame}
...
\begin{frame}
	...
	\frametitle{Results of root canal space extraction}%
		...
		\renewcommand{\imagewidth}{0.358565737*\imageheight}% 720/2008
