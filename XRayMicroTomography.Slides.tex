	...
	\defbeamertemplate{footline}{progress bar}{
		...
		\begin{beamercolorbox}[wd=\paperwidth,ht=1.36mm,dp=0pt]{}%
			...
			\ifnum\inserttotalframenumber>0
				...
				\pgfmathsetlengthmacro{\markx}{(\myframenumber/\inserttotalframenumber)*\paperwidth}
				\draw[ubRed] (\markx,0) -- (\markx,2*\halfheight);
				\fi
			\fi
			\end{tikzpicture}
		\end{beamercolorbox}%
...
\begin{frame}
	...
	\only<2|handout:2>{%
		% Show PJ
		\mode<beamer>{\animategraphics[autoplay,width=\imagewidth,every=\everyframe]{24}{./movies/EAWAG/animation.head/104016.head.rec.animation.0}{000}{120}}%
		\mode<handout>{\includegraphics[width=\imagewidth]{./movies/EAWAG/animation.head/104016.head.rec.animation.0120}}%
	}%
	\only<3|handout:0>{%
		% Show full head again
		\animategraphics[autoplay,width=\imagewidth,every=\everyframe]{24}{./movies/EAWAG/animation.head/104016.head.rec.animation.}{0121}{0240}%
	}%
	\only<4|handout:0>{%
		% Zoom to otolith
		\animategraphics[autoplay,width=\imagewidth,every=\everyframe]{24}{./movies/EAWAG/animation.head/104016.head.rec.animation.}{0240}{0360}%
	}%
	\only<5|handout:0>{%
		%Move to PJ
		\animategraphics[autoplay,width=\imagewidth,every=\everyframe]{24}{./movies/EAWAG/animation.head/104016.head.rec.animation.}{0361}{480}%
	}%
	\only<6|handout:0>{%
  ...
  \note[item]<6|handout:0>{Fish 104016, Scan pharynx\_rec; scanned on 2021-02-04T13:30:11 on the SkyScan1272, with a voxel size of \qty{5.0}{\micro\meter}.}%
	\note[item]<6|handout:0>{The distance between the two ends at the top is approximately \qty{5}{\milli\meter}.}%
		\only<8|handout:0>{%
		\animategraphics[autoplay,width=\imagewidth,every=\everyframe]{24}{./movies/EAWAG/animation.pj/104016.pj.animation.0}{000}{180}%
	}%
	\only<9|handout:0>{%
		\animategraphics[autoplay,width=\imagewidth,every=\everyframe]{24}{./movies/EAWAG/animation.pj/104016.pj.animation.}{0181}{0359}%
	}%
