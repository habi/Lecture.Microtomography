...
\begin{frame}
	...
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.495\linewidth}
			\lstinputlisting[linerange={2-4,7-7,15-18,28-29,31-31,36-37,42-42,45-45,55-56},linebackgroundcolor={\ifnum\value{lstnumber}=11\color{ubRed!61.8}\fi}]{./movies/EAWAG/161543/head_30um/proj/161543.log}%
		\end{column}
	\end{columns}
\end{frame}
