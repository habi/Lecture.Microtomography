...
\tikzset{%
    shadowed/.style={preaction={transform canvas={shift={(1pt,-1pt)}},
    draw=ubRed}},%
}
\usepackage{pgfplots}
...
\usepackage{colortbl}
\usepackage{multirow}
\usepackage[english,showseconds=false,showzone=false]{datetime2}% nice compilation date in handout
\DTMsettimestyle{iso}
\usepackage{appendixnumberbeamer}% do now count appendix frames in total frame count
\usepackage{qrcode}
...
\newcommand{\citeslide}[5]{% slideimage,lecturelink,lecturetitle,author,page
    \fboxsep=0pt%
    \fcolorbox{ubRed!62}{white}{\includegraphics[width=\linewidth,height=\imageheight,keepaspectratio]{#1}}% https://tex.stackexchange.com/a/12041/828
    \raisebox{-1.618ex}{%
        \makebox[0pt][r]{%
...
% After this frame, it's a good time for a break in the UPE lecture, so save us the frame number
\begin{frame}
    \frametitle{Visualization}
    \saveframenumber
    \begin{itemize}
...
\begin{frame}
    ...
    \only<1|handout:1>{%
        \begin{tikzpicture}[remember picture,overlay]%
            \node at (current page.center) [shift={(0,-2.9mm)}]{%
                \mode<beamer>{%
                    \animategraphics[autoplay,loop,width=0.98\paperwidth,every=\everyframe]{24}{./movies/tooth045/full/image0}{000}{474}%
                }%
                \mode<handout>{%
                    \includegraphics[width=0.98\paperwidth]{./movies/tooth045/full/image0000}%
                }%
            };%
        \end{tikzpicture}%
    }%
    ...
    \only<3|handout:3>{%
        \begin{tikzpicture}[remember picture,overlay]%
            \node at (current page.center) [shift={(0,-2.9mm)}]{%
                \mode<beamer>{%
                    \animategraphics[autoplay,loop,width=0.98\paperwidth,every=\everyframe]{24}{./movies/tooth045/full-slices/image0}{000}{466}%
                }%
                \mode<handout>{%
                    \includegraphics[width=0.98\paperwidth]{./movies/tooth045/full-slices/image0000}%
                }%
            };%
        \end{tikzpicture}%
    }%
...
\begin{frame}
    ...
    \begin{tikzpicture}[remember picture,overlay]%
        \node at (current page.center) [shift={(0,-2.9mm)}]{%
            \only<1|handout:0>{%
                \mode<beamer>{%
                    \animategraphics[autoplay,loop,width=0.98\paperwidth,every=\everyframe]{24}{./movies/tooth045/transparent-slices/image0}{000}{473}%
                }%
                \mode<handout>{%
                    \includegraphics[width=0.98\paperwidth]{./movies/tooth045/transparent-slices/image0000}%
                }%
            }%
            \only<2|handout:1>{%
                \mode<beamer>{%
                    \animategraphics[autoplay,loop,width=0.98\paperwidth,every=\everyframe]{24}{./movies/tooth045/transparent-slices-rcs/image0}{000}{457}%
                }%
                \mode<handout>{%
                    \includegraphics[width=0.98\paperwidth]{./movies/tooth045/transparent-slices-rcs/image0000}%
                }%
            }%
            \only<3|handout:0>{%
                \mode<beamer>{%
                    \animategraphics[autoplay,loop,width=0.98\paperwidth,every=\everyframe]{24}{./movies/tooth045/rcs/image0}{000}{413}%
                }%
                \mode<handout>{%
                    \includegraphics[width=0.98\paperwidth]{./movies/tooth045/rcs/image0000}%
                }%
            }%
        };%
    \end{tikzpicture}%
...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.5\linewidth}
            ...
            \only<3|handout:0>{%
                \lstinputlisting[linerange={2-4,6-7,14,16-18,26-29,32,36-38,41,45},
                    linebackgroundcolor={%
            ...
            \only<4|handout:0>{%
                \lstinputlisting[linerange={2-4,6-7,14,17-19,26-29,31,36-38,40,45},
                    linebackgroundcolor={%
                        \ifnum\value{lstnumber}=1 \color{ubRed!61.8}\fi
                        \ifnum\value{lstnumber}=5 \color{ubRed!61.8}\fi
                        \ifnum\value{lstnumber}=10 \color{ubRed!61.8}\fi
