...
%% Define us a moving circle at the bottom of the slides as progress indicator, generated with the help of Claude.ai
...
%  \leavevmode%
%  \hbox{%
%    \begin{beamercolorbox}[wd=\paperwidth,ht=4pt,dp=0pt]{}%
...
%          
%          % Position circle at the very bottom edge
%          \fill[white] 
%            ($(current page.south west)!\progressratio!(current page.south east) + (0, 2pt)$) 
%            circle (2pt);
