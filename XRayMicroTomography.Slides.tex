...
\begin{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.49\linewidth}
            ...
            \only<2|handout:2>{%
                \renewcommand{\imagewidth}{0.52\paperheight}% redefine imagewidth \only here so that we can use the simple way to draw a scale bar. 0.52 is a purely empirical value
    ...
    \note<4|handout:4>{Cone-beam \uct: A major development was the introduction of cone-beam \uct, which uses a cone-shaped X-ray beam and a flat-panel detector, allowing for faster image acquisition and higher resolution.
