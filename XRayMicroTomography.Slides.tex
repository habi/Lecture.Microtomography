...
\begin{frame}
	...
	\only<5|handout:0>{%
		\animategraphics[autoplay,palindrome,width=0.45\linewidth,every=\everyframe]{24}{./movies/diancta/Diancta_rec00000}{666}{904}%
		\sourcecite{Bochud2021}{\emph{Diancta phoenīx}}%
	}%
	\only<6|handout:4>{%
...
\begin{frame}
	...
	\only<3>{%
		...
		\mode<handout>{%
			\includegraphics[height=\imheight]{./movies/tooth045/edt-coronal/Tooth045_EDT_Coronal_168}%
			}%
		}%
\end{frame}
