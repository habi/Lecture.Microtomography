...
\begin{frame}[label=current]{Preparation}
	\begin{itemize}
		\item Study design
...
\renewcommand{\imwidth}{0.5\linewidth}

\begin{frame}[label=current]{Projections}
	\includegraphics[width=\imwidth]{./images/14_Physics_updated}%
	\sourcelink{ilias.unibe.ch/goto\_ilias3\_unibe\_sess\_1555733.html}{Laws of Physics for Microscopists by Michael Jaeger}{Slide 14}%
	\includegraphics[width=\imwidth]{./images/15_Physics_updated}%
	\source{ilias.unibe.ch/goto\_ilias3\_unibe\_sess\_1555733.html}{Slide 15}%
\end{frame}
