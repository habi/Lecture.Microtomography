	...
	\only<2>{%
		\begin{tikzpicture}[remember picture,overlay]%
			\node at (current page.center){%
				\animategraphics[palindrome,autoplay,width=\paperwidth,every=\everyframe]{25}{./movies/mouse_skull/mouse_skull}{001}{081}%
				};%
		\end{tikzpicture}%
		}%
\end{frame}
...
\begin{frame}{CT-Scanner}
	\centering
	\only<1>{%
		\movie[height=0.618\textheight]{\includegraphics[height=0.618\textheight]{./images/Ct-internals.jpg}}{2CWpZKuy-NE.mp4}%
...
\begin{frame}{Graphical overview}
	\centering
	...
	\begin{columns}
		\begin{column}{0.5\linewidth}
			\begin{itemize}
				...
				\item<2-4> First, second and third generation of scanners
...
\begin{frame}{Quantitative data}
	\begin{itemize}
		\item Raw numbers instead of just pretty imagescale
		\item Segmentation
...
\begin{frame}{Big data}
	\begin{itemize}
		\item TOMCAT 2560\(\times\)2160 @ 1500 fps \textgreater{} \SI{8}{\giga\byte\per\second}
		\item Desktop uCT can easily produce \SI{100}{\giga\byte} in a day
	\end{itemize}
\end{frame}
...
\begin{frame}{\href{https://en.wikipedia.org/wiki/Colophon_(publishing)}{Colophon}}
	\begin{itemize} 
		\item \textsc{beamer} presentation crafted in \LaTeX\xspace with the (slightly adapted) \href{http://intern.unibe.ch/dienstleistungen/corporate_design_und_vorlagen/praesentationen/index_ger.html}{template from from \emph{Corporate Design und Vorlagen} of the University of Bern}.
		\begin{itemize}
			\item Full source available on \href{https://github.com/habi/lecture_microtomography/}{GitHub}: git.io/fjpP7
			\item The \Latex\xspace code is automatically compiled with a \href{https://github.com/actions}{GitHub action} to a PDF which you can access here: XXXX
				Details on the way this works are specified in a \href{https://github.com/habi/latex-test/}{small test repository at GitHub}: git.io/JeOOj
